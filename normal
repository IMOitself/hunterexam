...
public class normal extends hunterProject{
	static void startGameNorm() {
	    ...
	    //DATABASE
	    String url = "jdbc:db-mysql-sgp1-information-management-do-user-9437339-0.l.db.ondigitalocean.com";
	    String username = "hunter_exam_user";
	    ...
	    try { // DATABASE CONNECTION
	        ...
	        while (isRunning) {
	        	ResultSet resultSet = statement.executeQuery("SELECT p1norm FROM hunter_exam ORDER BY RAND() LIMIT 1;");
		        if (resultSet.next()) {
